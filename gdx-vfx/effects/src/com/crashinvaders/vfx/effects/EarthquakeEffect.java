...
import com.crashinvaders.vfx.filters.EarthquakeFilter;
import com.crashinvaders.vfx.framebuffer.VfxFrameBuffer;
import com.crashinvaders.vfx.utils.ScreenQuadMesh;

public class EarthquakeEffect extends VfxEffect implements UpdateableEffect {

    private final EarthquakeFilter filter;
    ...
    public EarthquakeEffect(float amount, float speed) {
        filter = new EarthquakeFilter(amount, speed);
    }
